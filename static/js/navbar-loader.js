...
class NavbarLoader {
    ...
    init() {
        ...
        authSource = window.auth || window.authBootstrap;
        if (!authSource) {
        ...
        // Require authentication before loading navbar
        ...
        // Update user display after a short delay to ensure navbar is loaded
        const updateFn = () => this.updateUserDisplay();
        // Update once ready; also listen for late authReady signal
                            ...
                            <li class="nav-item">
                             ...
                             <li class="nav-item dropdown">
                                 ...
                                 <ul class="dropdown-menu modern-dropdown scrollable-dropdown">
                                     ...
                                     <!-- Asset Reports -->
                                     <li><h6 class="dropdown-header">Asset Reports</h6></li>
                                     <li><a class="dropdown-item modern-dropdown-item" href="/static/asset-reports.html">
                                         <i class="bi bi-hdd-stack me-2"></i>Asset Register
                                     </a></li>
                                     <li><a class="dropdown-item modern-dropdown-item" href="/static/asset-reports.html#depreciation">
                                         <i class="bi bi-graph-down me-2"></i>Depreciation Report
                                     </a></li>
                                     <li><a class="dropdown-item modern-dropdown-item" href="/static/asset-reports.html#maintenance">
                                         <i class="bi bi-tools me-2"></i>Maintenance Schedule
                                     </a></li>
